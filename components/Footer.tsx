  ...
  return (
    <footer>
      <div className="bg-black lg:hidden">
        <div className="mx-6 md:mx-12 lg:mx-16 py-7 text-white">
          <Link href="/">
            <svg className="h-5" fill="currentColor" viewBox="0 0 3940 610">
        ...
        <div className="mx-6 md:mx-12 lg:mx-16 py-7 text-white border-t md:hidden">
          <div>Get the Medium app</div>
          <div className="mt-5 flex gap-4">
            <Link href="/" rel="noopener follow">
              <Image
                ...
                src="/1 Crl55Tm6yDNMoucPo1tvDg.png"
                loading="lazy"
                width="135"
                height="41"
              />
            ...
            <Link href="/" rel="noopener follow">
              <Image
                ...
                src="/1 W_RAPQ62h0em559zluJLdQ.png"
                loading="lazy"
                width="135"
                height="41"
              />
